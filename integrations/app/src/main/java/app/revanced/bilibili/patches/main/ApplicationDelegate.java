...
public abstract class ApplicationDelegate extends Application {
    ...
    static {
        try {
            System.loadLibrary("biliroamingn");
        } catch (Throwable t) {
            Logger.error(t, () -> "Failed to load biliroamingn library");
        }
    ...
    public void onCreate() {
        ...
        Logger.debug(() -> String.format("Initializing BiliRoamingN on process %s cost %s ms", Utils.currentProcessName(), end - start));
    }
